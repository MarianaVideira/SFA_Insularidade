...
csh_2018 = rename_columns(csh_2018, column_map)
csh_2017 = rename_columns(csh_2017, column_map)
csh_2016 = rename_columns(csh_2016, column_map)
csh_2015 = rename_columns(csh_2015, column_map)

# STOPED HERE #######-----
# Double check if the names of variables are all the same. 
